...
namespace movie_rating_app.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,NationalityId,RoleName,BirthDate")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,NationalityId,RoleName,BirthDate")] Actor actor)
        {
            if (id != actor.Id)
            {
                return NotFound();
