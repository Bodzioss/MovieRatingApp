...
namespace movie_rating_app.Controllers
{
    public class CreatorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,NationalityId,BirthDate,CustomRole,Image")] Creator creator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,NationalityId,BirthDate,CustomRole,Image")] Creator creator)
        {
            if (id != creator.Id)
            {
                return NotFound();
