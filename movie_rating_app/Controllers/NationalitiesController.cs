...
namespace movie_rating_app.Controllers
{
    public class NationalitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id")] Nationality nationality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id")] Nationality nationality)
        {
