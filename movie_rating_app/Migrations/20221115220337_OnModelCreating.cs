        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Nationality = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NationalityNavigationName = table.Column<string>(type: "nvarchar(256)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUser_Nationalities_NationalityNavigationName",
                        column: x => x.NationalityNavigationName,
                        principalTable: "Nationalities",
                        principalColumn: "Name");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomRole = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NationalityNavigationName = table.Column<string>(type: "nvarchar(256)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Creators_Nationalities_NationalityNavigationName",
                        column: x => x.NationalityNavigationName,
                        principalTable: "Nationalities",
                        principalColumn: "Name");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesCast", x => new { x.MovieId, x.ActorId });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserMovie", x => new { x.MoviesId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_AspNetUserMovie_AspNetUser_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserMovie_Movies_MoviesId",
                        column: x => x.MoviesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieCreators_1", x => new { x.MovieId, x.CreatorId });
                    table.ForeignKey(
                        name: "FK_MovieCreators_Creators",
                        column: x => x.CreatorId,
                        principalTable: "Creators",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MovieCreators_Movies",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUser_NationalityNavigationName",
                table: "AspNetUser",
                column: "NationalityNavigationName");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserMovie_UsersId",
                table: "AspNetUserMovie",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Creators_NationalityNavigationName",
                table: "Creators",
                column: "NationalityNavigationName");
